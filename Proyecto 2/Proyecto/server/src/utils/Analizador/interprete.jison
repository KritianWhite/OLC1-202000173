...
declaracion : tipo lista_ids IGUAL e PYC  { $$ = new declaracion.default($1, $2, $4,@1.first_line, @1.last_column);}  
            ...
            | tipo CORA CORC CORA CORC lista_ids IGUAL NEW  tipo CORA e CORC  CORA  e CORC PYC         { $$ = new declaracion.default($1, $6, null,  @1.first_line, @1.last_column);}
            | tipo CORA CORC  lista_ids IGUAL e PYC { $$ = new declaracion.default($1, $4, $6,  @1.first_line, @1.last_column);}
            | tipo CORA CORC CORA CORC lista_ids  IGUAL LLAVA doublearray  LLAVC  PYC      { $$ = new declaracion.default($1, $6, null,  @1.first_line, @1.last_column,$1,$4,$7,$11);}
            ;
